...
export function IDVerify({ id, isVerified }: IDVerifyProps) {
    return (
        <div className="flex items-center justify-between p-4 bg-zinc-900/60 backdrop-blur-md border border-zinc-800/50 rounded-xl mb-3 shadow-sm">
            ...
            {!isVerified && (
                <button className="flex items-center gap-1 text-xs font-semibold text-zinc-950 bg-amber-500 hover:bg-amber-400 px-3 py-1.5 rounded-full transition-all active:scale-95 shadow-sm shadow-amber-500/20">
                    Verificar
