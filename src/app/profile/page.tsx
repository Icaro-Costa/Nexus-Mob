        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 relative min-h-screen">
            ...
            <div className="relative pt-6 px-4">
                <div className="flex items-start justify-between">
                    ...
                    <button className="p-2 bg-zinc-900/60 backdrop-blur-md rounded-full text-zinc-400 hover:text-zinc-100 transition-colors active:scale-95">
            ...
            <div className="mt-8 px-4">
                ...
                <div className="flex gap-2">
                    <div className="flex items-center gap-1.5 bg-amber-500/10 text-amber-500 border border-amber-500/20 px-3 py-1.5 rounded-full text-xs font-semibold backdrop-blur-sm">
                        <Shield className="w-3.5 h-3.5" />
                        Vendedor Verificado
                    </div>
                    <div className="flex items-center gap-1.5 bg-blue-500/10 text-blue-400 border border-blue-500/20 px-3 py-1.5 rounded-full text-xs font-semibold backdrop-blur-sm">
            ...
            <div className="mt-8 px-4">
                <div className="flex justify-between items-end mb-3">
                    ...
                    <button className="text-xs font-medium text-amber-500 hover:text-amber-400 active:scale-95 transition-transform">
                        + Novo ID
                    </button>
                </div>
            ...
            <div className="mt-8 px-4">
                <Link href="/profile/work-with-us" className="block w-full bg-zinc-900/60 backdrop-blur-md border border-zinc-800/50 hover:border-zinc-700/50 rounded-xl p-4 transition-all group active:scale-[0.98]">
                    <div className="flex justify-between items-center">
                        ...
                        <div className="bg-zinc-800/80 group-hover:bg-amber-500 group-hover:text-zinc-950 p-2 rounded-full transition-colors text-zinc-400 shadow-sm">
            ...
            <div className="mt-8 px-4 pb-8 border-t border-zinc-800/50 pt-6">
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center bg-zinc-900/30 backdrop-blur-sm rounded-2xl border border-zinc-800/50 border-dashed">
